...
char   HOST_NAME[] = "192.168.0.106"; // change to your PC's IP address
String PATH_NAME   = "/iot_ilm/data-api.php";
String getData;
int status = WL_IDLE_STATUS;     // the Wifi radio's status

//Init pin
int ledR=13, ledY=12, ledG=11; //init pin for led
int LDR=A1;
int FL=A2;
...
void loop()
{
  ...
  float sensor1=random(bacaLDR);
  float sensor2=random(bacaFL);
